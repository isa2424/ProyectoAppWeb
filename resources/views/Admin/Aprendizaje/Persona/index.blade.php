              ...
              <table id="example1" class="table table-bordered table-striped table-responsive display nowrap">
                ...
                <tbody>
                  <?php $i=0;?>
                    ...
                    @if($user->Id_InicioSesion != Auth::User()->id)
                        <?php $i++;?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <img src="{{ url('http://localhost/ProyectoIsabel/Imagenes/Usuarios/'.$user->Foto) }} " class="img-responsive">
                        ...
                        <td>
                          ...
                          <td>
                            <a class="btn btn-success btn-sm"  href="{{ route('persona.edit',$user->Id_Persona) }}">
