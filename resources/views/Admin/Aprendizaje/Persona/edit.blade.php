            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('persona.update', $user->Id_Persona) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input value="{{ $user->Nombres }}" autofocus required name="Nombres" type="text"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input value="{{ $user->Apellidos }}" required name="Apellidos" type="text"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input value="{{ $user->Telefono }}" type="text" name="Telefono"
                                ...
                                <div class="col-md-6">
                                    ...
                                    @foreach ($InicioSesion as $count)
                                        @if ($count->id == $user->Id_InicioSesion)
                                            <input readonly value="{{ $count->email }}" required type="email"
                                                name="Correo" placeholder="Enter email" class="form-control">
                                        @endif
                                    @endforeach
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if ($user->Id_TipoPersona == '1')
                                        ...
                                        <select class="form-control js-example-basic-single" name="Id_TipoPersona">
                                            ...
                                            <option {{ $user->Id_TipoPersona == '1' ? 'selected' : '' }} value="1">
                                    ...
                                    @if ($user->Id_TipoPersona == '3')
                                        <select class="form-control js-example-basic-single" name="Id_TipoPersona">
                                            {{-- <option {{ $user->Id_TipoPersona == '2' ? 'selected' : ''}} value="2">Usuario</option> --}}
                                            <option {{ $user->Id_TipoPersona == '3' ? 'selected' : '' }} value="3">
                                                Instructor</option>
                                        </select>
                                    @endif
                                    @if ($user->Id_TipoPersona == '2')
                                        <select class="form-control js-example-basic-single" name="Id_TipoPersona">
                                            <option {{ $user->Id_TipoPersona == '2' ? 'selected' : '' }} value="2">Usuario
                                            </option>
                                        </select>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="country_id" class="form-control js-example-basic-single"
                                        ...
                                        @foreach ($provincias as $coun)
                                            <option value="{{ $coun->Id_Provincia }}"
                                                {{ $user->Id_Provincia == $coun->Id_Provincia ? 'selected' : '' }}>
                                                {{ $coun->Descripcion }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                @if ($user->Foto != null || $user->Foto != '')
                                    <div class="edit-user-img">
                                        <img src="{{ url('http://localhost/ProyectoIsabel/Imagenes/Usuarios/' . $user->Foto) }}"
                                            class="img-fluid" alt="User Image" class="img-responsive">
                                    </div>
                                @else
                                    <div class="edit-user-img">
                                        <img src="{{ asset('images/default/user.jpg') }}" class="img-fluid"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea id="detail" name="Descripcion" class="form-control" rows="5"
                                placeholder="Enter your details" value="">{{ $user->Biografia }}</textarea>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ route('persona.index') }}" title="Cancel and go back"
